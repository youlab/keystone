...
filename1= '20250506_E55-E57_ResourceCompet_TimeCourse'; % assigned name of the data file to be read
...
trowNo = 19; % manually find the row number for the time information

% time = num1(trowNo, :)/3600; % time vector in hours

time = num1(trowNo, 1:300)/3600; % time vector in hours
...
% average the technical replicates for each strain
% AvgTechReps
