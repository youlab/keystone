...
BgNoCTX = mean([M(2, 8, :); M(3, 8, :); M(4, 8, :)], 1);

BgCTX2p5 = mean([M(5, 8, :); M(6, 8, :); M(6, 8, :)], 1);
...
B5 = M(5, 2, :) - BgCTX2p5; B5 = movmean(B5(:), k); B5(B5<0) = 0;

B6 = M(6, 2, :) - BgCTX2p5; B6 = movmean(B6(:), k); B6(B6<0) = 0;

B7 = M(7, 2, :) - BgCTX2p5; B7 = movmean(B7(:), k); B7(B7<0) = 0;
...
C5 = M(5, 3, :) - BgCTX2p5; C5 = movmean(C5(:), k); C5(C5<0) = 0;

C6 = M(6, 3, :) - BgCTX2p5; C6 = movmean(C6(:), k); C6(C6<0) = 0;

C7 = M(7, 3, :) - BgCTX2p5; C7 = movmean(C7(:), k); C7(C7<0) = 0;
...
E5 = M(5, 5, :) - BgCTX2p5; E5 = movmean(E5(:), k); E5(E5<0) = 0;

E6 = M(6, 5, :) - BgCTX2p5; E6 = movmean(E6(:), k); E6(E6<0) = 0;

E7 = M(7, 5, :) - BgCTX2p5; E7 = movmean(E7(:), k); E7(E7<0) = 0;
...
F5 = M(5, 6, :) - BgCTX2p5; F5 = movmean(F5(:), k); F5(F5<0) = 0;

F6 = M(6, 6, :) - BgCTX2p5; F6 = movmean(F6(:), k); F6(F6<0) = 0;

F7 = M(7, 6, :) - BgCTX2p5; F7 = movmean(F7(:), k); F7(F7<0) = 0;


G2 = M(2, 7, :) - BgNoCTX; G2 = movmean(G2(:), k); G2(G2<0) = 0;

G3 = M(3, 7, :) - BgNoCTX; G3 = movmean(G3(:), k); G3(G3<0) = 0;

G4 = M(4, 7, :) - BgNoCTX; G4 = movmean(G4(:), k); G4(G4<0) = 0;
...
H2 = M(2, 9, :) - BgNoCTX; H2 = movmean(H2(:), k); H2(H2<0) = 0;

H3 = M(3, 9, :) - BgNoCTX; H3 = movmean(H3(:), k); H3(H3<0) = 0;

H4 = M(4, 9, :) - BgNoCTX; H4 = movmean(H4(:), k); H4(H4<0) = 0;
...
I2 = M(2, 10, :) - BgNoCTX; I2 = movmean(I2(:), k); I2(I2<0) = 0;

I3 = M(3, 10, :) - BgNoCTX; I3 = movmean(I3(:), k); I3(I3<0) = 0;

I4 = M(4, 10, :) - BgNoCTX; I4 = movmean(I4(:), k); I4(I4<0) = 0;
...
J2 = M(2, 11, :) - BgNoCTX; J2 = movmean(J2(:), k); J2(J2<0) = 0;

J3 = M(3, 11, :) - BgNoCTX; J3 = movmean(J3(:), k); J3(J3<0) = 0;

J4 = M(4, 11, :) - BgNoCTX; J4 = movmean(J4(:), k); J4(J4<0) = 0;
